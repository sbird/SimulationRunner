...
def test_full_integration():
    ...
    Sim = simulationics.SimulationICs(outdir=defaultpath,box = 256,npart = 96, redshift = 99, code_args={'redend':0})
...
def test_only_DM():
    ...
    Sim = simulationics.SimulationICs(outdir=outdir, box = 256, npart = 96, redshift = 99, separate_gas=False, code_args={'redend':0},hubble=0.71)
    Sim.make_simulation(pkaccuracy=0.07)
