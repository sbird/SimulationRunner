...
class NeutrinoHybridICs(NeutrinoSemiLinearICs):
    """Further specialise the NeutrinoPartICs class for semi-linear analytic massive neutrinos.
    """
    def __init__(self, *, npartnufac=0.5, vcrit=500, zz_transition = 1, **kwargs):
    ...
    def _other_params(self, config):
        ...
        config = NeutrinoSemiLinearICs._other_params(self, config)
